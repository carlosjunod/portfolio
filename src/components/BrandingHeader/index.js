...
const BrandingHeader = ({content}) => (
  <header id="branding-header">
    <div className="text-col">
      <img src={branding} alt="Branding"/>
      <p>I also enjoy making brands, here is a little sample of my latest works. you also can see more of it on my dribbble profile.</p>
    </div>
  
    
    <a href="" className="drible">
