    ...
    this.state = {
      ...
      projects: [
        {
          ...
          imgs: [
            {src:process.env.REACT_APP_LOCAL_URL+'/images/img_web_HMM_mobile.png', 
        ...
        },
        {
          ...
          content: 'Aenean tincidunt gravida libero, at fermentum lorem euismod imperdiet. Maecenas venenatis dui eu nisl euismod, non mattis sapien auctor. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Maecenas nec ligula ut nulla convallis ultrices. Quisque dapibus, massa a laoreet facilisis, leo dui pulvinar turpis, ac faucibus nulla dui ut lacus. Vestibulum ac gravida tortor, a blandit metus. Nunc aliquet iaculis odio vestibulum sollicitudin. Suspendisse pulvinar ultricies egestas. Cras bibendum, libero sed ultrices tristique, tortor erat tempor massa, quis volutpat quam eros quis mi. Cras facilisis sodales nibh, eget maximus nibh interdum at. Aliquam orci leo, efficitur nec mauris quis, fermentum lacinia leo. Ut nec tortor non ex bibendum dapibus et in eros. Proin ornare nunc eu enim pretium laoreet at dapibus mi. Nam et ex justo. Fusce in vulputate nunc, sed vestibulum nibh.',
          tech: ["devicon-wordpress-plain", "devicon-html5-plain", "devicon-sass-original" ,"devicon-gulp-plain", "devicon-javascript-plain"],   
          bg_color: '#FEC241',
          txt_color: '#263238',
          animation: {
            x1:'0px',
      ...
      branding: {
        project_1:{
          ...
          content: 'Aenean tincidunt gravida libero, at fermentum lorem euismod imperdiet. Maecenas venenatis dui eu nisl euismod, non mattis sapien auctor. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.'
        },
        project_2:{
          title: 'CCM Stucco',
          bg_color: '#106897',
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        {/* PROJECTS: */}
        <section>
         { this.state.projects.map(this._renderProjects) }
        </section>
